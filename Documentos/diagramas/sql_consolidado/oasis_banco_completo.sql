...
-- Tipos criados na consolidacao do schema (antes eram VARCHAR com CHECK)
CREATE TYPE status_conta_enum        AS ENUM ('AGUARDANDO_PRIMEIRO_ACESSO','ATIVO','BLOQUEADO');
CREATE TYPE tipo_limite_reserva_enum AS ENUM ('DIARIO','SEMANAL','MENSAL');
CREATE TYPE status_livre_enum        AS ENUM ('LIVRE','EM_USO');
CREATE TYPE tipo_codigo_enum         AS ENUM ('PRIMEIRO_ACESSO','RECUPERACAO');
CREATE TYPE papel_controle_enum      AS ENUM ('MORADOR','SINDICO','PORTEIRO','VISITANTE','PRESTADOR_SERVICO');

-- Observacao: em tipo_perfil_enum, o valor ADMINISTRADOR e tratado pela
-- aplicacao como sinonimo de SINDICO (equivalencia resolvida em
-- backend/src/auth/guards.ts). Ambos concedem o perfil de administracao.
...
CREATE TABLE pessoa (
    ...
    papel_controle   papel_controle_enum NOT NULL DEFAULT 'MORADOR',
...
CREATE TABLE area_comum (
    ...
    tipo_limite_reserva       tipo_limite_reserva_enum NOT NULL DEFAULT 'SEMANAL',
    ...
    status_livre              status_livre_enum NOT NULL DEFAULT 'LIVRE',
    status_livre_atualizado_em TIMESTAMPTZ      DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE entrega_chave (
    ...
    CONSTRAINT ck_ec_solicitante CHECK (id_perfil_solicitante IS NOT NULL OR id_pessoa_solicitante IS NOT NULL),
...
CREATE TABLE codigo_primeiro_acesso (
    ...
    tipo                 tipo_codigo_enum         NOT NULL DEFAULT 'PRIMEIRO_ACESSO',
...
-- ---------------------------------------------------------------------
INSERT INTO pessoa (nome, email, cpf, data_nascimento, celular) VALUES
    ('Carlos Silva',    'carlos.silva@teste.com',
     '11122233344', '1985-04-12', '42999110001'),
    ('Maria Santos',    'maria.santos@teste.com',
     '22233344455', '1990-09-30', '42999110002'),
    ('Joao Oliveira',   'joao.oliveira@teste.com',
     '33344455566', '1998-01-25', '42999110003'),
    ('Ana Paula Souza', 'ana.souza@teste.com',
     '44455566677', '1979-06-08', '42999110004'),
    ('Roberto Lima',    'roberto.lima@teste.com',
     '55566677788', '1982-11-17', '42999110005'),
    ('Helena Braga',    'helena.braga@teste.com',
