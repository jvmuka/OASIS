      ...
      <Cartao>
        ...
        {avisos.length === 0 ? (
          <EmptyState
            ...
            descricao="Clique no botão acima para emitir o primeiro aviso para o condomínio."
            acao={
              <Botao
                variante="primario"
                tamanho="sm"
          ...
          <div className="space-y-3">
            {avisos.map(a => {
              ...
              return (
                <div
                  key={a.id_aviso}
                  className="rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-800/80 p-4 shadow-soft transition-all hover:border-slate-300 dark:hover:border-slate-700"
                >
